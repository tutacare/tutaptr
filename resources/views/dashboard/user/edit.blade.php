	...
	<div class="row">
		<div class="col-md-10 col-md-offset-1">
			<div class="panel panel-default">
				<div class="panel-heading">{{trans('tuta.update_user')}}</div>

				<div class="panel-body">
					{!! Html::ul($errors->all()) !!}

					{!! Form::model($user, array('route' => array('dashboard.users.update', $user->id), 'method' => 'PUT')) !!}
          ...
          <div class="form-group">
							...
							{!! Form::select('role', array('Administrator' => 'Administrator', 'Subscriber' => 'Subscriber'), null, array('class' => 'form-control')) !!}
					</div>
